                    ...
                    {loading ? (
                        <Tr>
                            <Td colSpan={allHeaders.length} textAlign="center">
                                <Loader type="spinner-circle" bgColor={"#3182CE"} color={"black"} size={50} />
                            </Td>
                        </Tr>
                    ) : data.length === 0 ? (
                        <Tr>
                            <Td colSpan={allHeaders.length} textAlign="center">No Data found</Td>
                        </Tr>
                    ) : (
...
>>>>>>> 82f276a001f0c11988b28d61713a07f50e07855b
